              ...
              <div>
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    <UsersAutocomplete roles={["admin","administrator","super","super-admin","super_admin","super admin","superadmin","employee"]} value={assignedUser} onSelect={(u) => { setAssignedUser(u as any); setForm((f) => ({ ...f, assigned_to: u ? String(u.id) : "" })); }} placeholder="Type user name" />
                  </div>
